...
`,
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"routeros_interface_ethernet_switch_qos_tx_manager_queue": ResourceInterfaceEthernetSwitchQosTxManagerQueue(),
			...
			// Queue
			"routeros_queue_interface": ResourceQueueInterface(),

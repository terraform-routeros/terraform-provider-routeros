...
func testCheckMinVersion(t *testing.T, version rosVersionType) bool {
	if ROSVersion < version {
		t.Logf("Test skipped, the minimum required version is %v", version.String())
		return false
	}
	return true
}
